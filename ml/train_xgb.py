...
# PASO 5: MODELO 2 - XGBOOST MULTICLASE
print("\n" + "=" * 60)
print("  ENTRENANDO MODELO 2: XGBOOST MULTICLASE (UPDRS)")
print("=" * 60)
...
y_prob_up = xgb_multiclass.predict_proba(X_test_up_scaled)
...
axes[1].set_title("XGB - Confusion Matrix (UPDRS Multiclase)")
